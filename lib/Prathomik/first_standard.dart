...
class first_standard extends StatelessWidget {
  const first_standard({Key? key}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Text("প্রথম শ্রেণি",style: TextStyle(fontSize: 20,fontWeight: FontWeight.bold),),
