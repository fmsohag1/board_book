...
class fifth_standard extends StatelessWidget {
  const fifth_standard({Key? key}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        ...
        appBar: AppBar(
          ...
          title: Text("পঞ্চম শ্রেণি",style: TextStyle(fontSize: 20,fontWeight: FontWeight.bold),),
